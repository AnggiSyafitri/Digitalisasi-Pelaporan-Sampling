...
$formulir = $conn->query("SELECT * FROM formulir_air WHERE id=$id")->fetch_assoc();
$contoh = $conn->query("SELECT * FROM contoh_air WHERE formulir_id=$id");
?>
<!DOCTYPE html>
<html lang="id">
<head>
<meta charset="UTF-8">
<title>Cetak Formulir Air</title>
<style>
